...
public class OpenBrowserTest {
    ...
    public void SetUp(@Optional("https://www.bing.com/search") String url) {
    ...
    public void bingurl(){
        ...
        By.xpath("//ol[@id='b_results']//h2/a")));

        List<WebElement> wb = driver.findElements(By.xpath("//ol[@id='b_results']//h2/a"));
        ...
        while(it.hasNext()){
            ...
            if (text.contains(keyword) || s.contains(keyword)) {
                // relevantCount++;
                System.out.println("VALID: " + text );
            } else {
                System.out.println("NOT RELEVANT: " + text);
            }
            // Assert.assertTrue(relevantCount > 0,
            //     "No relevant search results found for keyword: " + keyword);
            }
        }
